    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if(isAmountEmpty(amount)){
                    ...
                    if (categoryval.equals("Choose category")){
                        Toast.makeText(Add_income.this,"Choose category",Toast.LENGTH_SHORT).show();
                    }
                    else{
                        ...
                        if(id==0){
                            ...
                            Intent intent = new Intent(Add_income.this,Income.class);
                            startActivity(intent);
                            finish();
                        }else {
                            databaseHelper.updateincome(id,contentValues);
                            Toast.makeText(Add_income.this,"Income updated",Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id==0){
                    Intent intent = new Intent(Add_income.this, Navigation_drawer.class);
                    startActivity(intent);
                    finish();
                }else{
                    Intent intent = new Intent(Add_income.this, Income.class);
